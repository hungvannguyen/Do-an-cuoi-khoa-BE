...
def create_confirm_code_email(account, db: Session):
    ...
    obj_db.insert_at = datetime.utcnow()
    obj_db.update_at = datetime.utcnow()
    ...
    return send_mail(mail_to=mail_to, title="[DhsGundam] Đây là mã xác thực của bạn!", content=text)
